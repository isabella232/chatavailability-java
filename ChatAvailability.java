...
public class ChatAvailability {
	...
	static String chatavailability = "/system/ws/chat/entrypoint/agentAvailability/{entryId}";
	static String entryPointID = "1004";
    ...
    {
    	ChatAvailability chat = new ChatAvailability();
    	chat.anonymousinit();
    	System.out.print(chat.availablity());
    }
}
